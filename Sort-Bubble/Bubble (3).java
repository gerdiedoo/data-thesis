...
public class Bubble extends javax.swing.JFrame {
    ...
    public void donewBubble(int[] input){
	...
	int progress=i+1;
		...
		jProgressBar1.setString("PASS "+progress+" / 6");
			...
			jProgressBar2.setValue(0);
                    ...
                    jProgressBar2.setString("input[j] =  "+input[j]);
                    jProgressBar3.setValue(0);
                    jProgressBar3.setString("input[j+1] =  "+input[j+1]);
		...
		elements.get(j+1).setBackground(Color.PINK);
                ...
                if(input[j] > input[j+1]){
                    JTextField jTemp = elements.get(j+1);
                    temp = input[j];
                    input[j] = input[j+1];
                    input[j+1] = temp;
                    moveFirst(elements.get(j), coordinates.get(j+1));
                    moveSecond(elements.get(j+1), coordinates.get(j));
                    elements.put(j+1, elements.get(j));
                    elements.put(j, jTemp);
                }
            }
        }
	...
	jProgressBar2.setForeground(Color.ORANGE);
        jProgressBar3.setForeground(Color.PINK);

        jProgressBar2.setFont(new java.awt.Font("Norasi", 1, 16)); 
        jProgressBar2.setString("j index value");

        jProgressBar3.setFont(new java.awt.Font("Norasi", 1, 16)); 
        jProgressBar3.setString("j+1 index value");
        ...
        jButton1.setText("Start Bubble Sort");
